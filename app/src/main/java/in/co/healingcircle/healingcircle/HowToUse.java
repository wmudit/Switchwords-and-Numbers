...
public class HowToUse extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_switchwords) {
            startActivity(new Intent(HowToUse.this, Home.class));
        } else if (id == R.id.nav_use) {

        } else if (id == R.id.nav_about) {
            startActivity(new Intent(HowToUse.this, AboutSwitchwords.class));
            ...
            startActivity(new Intent(HowToUse.this, GetInTouch.class));
        }
